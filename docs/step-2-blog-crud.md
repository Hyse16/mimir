...
- `develop.md` lists `BlogAsset` in STEP 2, while resizing, compression, analysis images, and ordering form the STEP 3 image pipeline. Asset persistence and endpoints remain unimplemented until that boundary is resolved as part of STEP 3 planning.
